...
import logo_header from '../../assets/imagens/logo.svg'
    ...
    return (
        <>
            <header >
                ...
                <div className={`flex justify-center text-center w-full h-full py-2 bg-white z-10 relative transform duration-300 ${openMenu ? 'mt-0' : '-mt-44'}`} id='itens'>
